...
## 1. Why Neeve exists — the lived experience we are designed to address

People with chronic illness often know more about their own bodies than the doctors who see them for fifteen minutes. They also get believed less. This is the gap Neeve is built into.

The research is clear about what happens to people in this gap. Bokek-Cohen and Gabay interviewed hospitalised patients about what they call "medical gaslighting": clinicians who *"dismiss or invalidate a patient's reported symptoms"* and pin them on *"stress, obesity, poor nutrition, mental health, side effects of medications, or lack of exercise"*, leaving the patient *"to question their own bodily experiences, emotions, or judgment"* [1, p. 2]. The downstream cost isn't abstract. The same paper documents delayed diagnosis, illness that worsens because nobody acted, lasting psychological distress, and a slow erosion of trust in the whole healthcare system [1, p. 5].

It isn't just rude doctors. The problem is structural. de Boer's analysis of the Dutch ME/CFS Health Council process shows that ill people get hit twice: once when their reports are treated as unreliable, and again when nobody has built the language to make sense of what they're describing. She puts it this way: ill people are *"particularly vulnerable to testimonial injustice because they are often attributed with certain characteristics that negatively affect their credibility, such as being emotionally unstable or irrational"*, and to hermeneutic injustice because *"the interpretative sources available to them … are lacking or are too impoverished in order for them to understand their experiences"* [2, p. 1337]. Translated: you're told your reports aren't data, then you're told the absence of data means your illness isn't real.

This hits women harder. Laughey and colleagues describe a measurable gender pain gap, where *"women feeling dismissed by clinicians, along with stigma and lack of knowledge, are key barriers to seeking health care"*. The result is delay: *"conditions requiring immediate attention may be prolonged, with treatment sought only when severity can no longer be ignored, by which point body systems may already be negatively impacted"* [3, p. 2]. Brauer and colleagues asked endometriosis patients what they wanted from their doctors, and the answer came back in one sentence: *"Take me seriously or educate yourself, but don't dismiss it"* [4, p. 11]. The patients in that study said being dismissed left them with *"frustration, uncertainty about their future and a feeling of powerlessness"* [4, p. 11].

There's also a part nobody sees. Estecha Querol and colleagues describe what they call "non-visible disease" — the load chronic illness puts on a person's life that never makes it into a clinical record. They write that *"much of the struggle is hidden, linked to poverty, debt, isolation, emotional distress and mental ill health"* [5, p. 10], and that people in their study described *"not seeking professional help for mental health problems, in contrast to their help-seeking for physical symptoms"* [5, p. 8]. The illness exists. The clinical record does not.

Put these five papers together and the picture is consistent. People with chronic illness — and especially chronically-ill women — hold real, hard-won knowledge about their own bodies, and the medical system is structurally bad at receiving it. They get disbelieved in conversation [1], discredited in policy [2], under-treated for pain [3], waved away at diagnosis [4], and left to carry the invisible half of the illness alone [5]. The result is delay, distrust, and a quiet withdrawal from the very systems meant to help. Neeve is built into that gap. It is for people who have already been told their symptoms are stress, normal, or in their head, and who need a way to organise what they know about their own bodies into something a doctor can't easily wave away.
...
## 2. How we measure — ecological momentary assessment (EMA)

Neeve's check-in system is based on a method called ecological momentary assessment, or EMA — short, repeated, in-the-moment self-reports, captured in everyday life rather than once a fortnight in a clinic. The methodology section of this document references the May et al chronic-pain EMA review [59], which establishes the high-level shape: two anchored check-ins a day, event-based moments in between, the same scales every time, and timestamps for both when the prompt fired and when the user actually answered. Three more papers tell us what the actual questions should look like, what scale to use, and whether one carefully-worded question can do the work of a whole multi-item scale.

Hall and colleagues looked at 234 EMA studies of mood and anxiety. They found the field is everywhere: prompts ranged from 1 to 64 a day, studies ran from 1 to 240 days, and more than 4,600 different items were used. Only 8.97% of the studies reported both reliability and validity for what they actually asked [6]. The most important finding for Neeve is that you can't just take a clinic questionnaire designed for once-a-fortnight use, copy it into an app, and ping people six times a day with it. As Hall puts it: *"These types of questionnaires may not be appropriate or transferable to an intensive longitudinal design… administering this questionnaire multiple times per day would render its validity questionable"* [6, p. 2]. The same review found that even tiny differences in wording — "today" versus "in the last day" — change what people report, and that people genuinely struggle to delineate their experience to narrow windows like "in the last hour". For a whole-day reflection, "today" or "over the last 24 hours" works better than anything finer-grained. Across all 234 studies, the most common scale was a 5-point Likert variant, and the most common framing for in-the-moment items was the simple phrase "right now".

The deeper question — whether a single question can replace a multi-question scale, which matters a lot if you want to keep the check-in down to four items — has been answered well. Song and colleagues ran 5,020 EMA observations across 45 adults with generalised anxiety and/or depression, prompted four times a day for 30 days [7]. In 27 of 29 single-item tests, the single item carried significant predictive validity, with effect sizes averaging 75% of the multi-item version. In one case the single item beat the full scale. Their conclusion is the empirical green-light for our design: *"an equally valid single-item measure can be regarded as sufficiently reliable as a multiple-item measure… concurrently and predictively valid single items will undoubtedly prove useful in EMA studies where full scales may cause unnecessary participant burden and lower their response quality"* [7, pp. 1663, 1669]. Their explanation for why is the same idea Neeve is built on: when the same person answers the same item across many days, they build a personal frame of reference. The within-person trajectory tells the story, not comparison to other people. Song's team also warned that the question has to be narrow — they used "sleep problems" as an example of a question too broad to work as a single item, because the person can't decide what to collapse into one rating. That's a direct caution against composite "how are you" or "general wellbeing" questions.

Tarca and colleagues showed the approach works in a chronically-ill audience too. They ran an mEMA study with 48 adults on peritoneal dialysis, using a single 0-10 mood scale ("Pick a number from 0 to 10: at the moment I feel," anchored at 0 = happy and 10 = sad) and a fatigue scale, prompted five times a day for a week [8]. They got 73% overall adherence, with most participants saying the app was *"easy, quick, and simple to use"* [8, p. 605]. A one-unit change in mood was associated with a 5.2-unit change in fatigue (95% CI 4.55-5.93, p < 0.01) — proof that single-item 0-10 scales can pick up real, clinically meaningful within-person variation in a sick population. Two things from this study translate directly into Neeve. The participants' main complaint was that their survey felt repetitive — *"Same questions asked 10 different ways"* (Table 5) — which is the case for keeping our core questions to four distinct items, not near-duplicates. And the most-requested addition was items covering anxiety and pain alongside fatigue and mood, which supports a fixed core set covering the major felt-experience domains rather than a constantly-rotating set.
...
3. **Decision points** — *"points in time at which an intervention decision must be made"* [9, p. 448, Table 1]. For Neeve: the morning and evening check-in slots, the moment a flagged biometric pattern is detected (like a sustained HR jump), and any user-initiated "something is happening" log.
4. **Tailoring variables** — *"information concerning the individual that is used for individualisation (i.e., to decide when and/or how to intervene)"* [9, p. 448]. For Neeve: yesterday's carry-forward values, ring-derived HRV/HR/SpO2 changes against the user's own baseline (not population baselines), local weather/AQI/pollen/UV from postcode, days since their last crash, and their stated condition profile.
...
Receptivity is the difference between a JITAI and a push-notification machine. Nahum-Shani defines it as *"the individual's transient ability and/or willingness to receive, process, and utilise just-in-time support"* [9, p. 450] — basically, "is this person actually in a place to hear from us right now". The paper is explicit about what happens when you ignore receptivity: *"providing support when the person is not receptive will not be beneficial and may even have negative implications on engagement with the intervention and intervention fatigue"* [9, p. 450].
...
Neeve has two witnesses. The check-in is what the user says. The ring is what the body says while the user gets on with their day. Both feed the engines in §5, and both end up in the doctor PDF in §7. This section grounds the ring half. It is deliberately conservative. The ring is the silent witness, never the verdict — and a witness is only as credible as the chain of custody on what they saw. Every claim Neeve makes from ring data has to survive a sceptical clinician asking "how do you know that?"

The structure here is a translation. The general PPG literature sets a floor — what reflective finger photoplethysmography can defensibly do in any device. The Neeve Ring hardware sets a ceiling — what this specific device, at firmware-default sample rates and a 10-minute autonomous monitor cadence, actually delivers. §4.3 is the per-metric table that reconciles the two: what we claim, what we don't, what the doctor PDF footer says.

### 4.1 What reflective finger PPG can defensibly do

Photoplethysmography (PPG) is the optical measurement of blood volume changes under the skin. A light source illuminates the tissue and a photodetector measures how much light comes back; pulsatile arterial blood absorbs more light during systole than diastole, producing a waveform from which heart rate, oxygen saturation, respiration, and pulse-derived variables can be inferred. Reflective PPG, the mode the Neeve Ring uses, places source and detector on the same side of the skin. Transmissive PPG — the hospital fingertip pulse oximeter — shines through the finger. Both work; reflective is harder to keep clean.

The most directly relevant study for the Neeve Ring's form factor is Longmore et al. (2019), who placed eight matched reflective PPG sensors at different anatomical sites and compared heart rate, SpO₂, and respiration rate against a commercial transmissive finger pulse oximeter and a chest-band respiration shirt. Their bottom line: *"the finger to be the best location for measurement of all three parameters at rest"* [47, p. 1]. At rest, finger reflective PPG produced median heart-rate error of *"1.5 (±16%) using both the red and IR channels combined"* [47, p. 9] and SpO₂ median error of *"2.1% ± 1.2%"* [47, p. 11] against the commercial reference. The same study is honest about what breaks: walking degraded finger SpO₂ to a *"median error larger than 19%"* at most sites and substantially widened the finger's own standard deviation, attributable to *"movement artefacts introduced into the waveform from each step"* [47, p. 13]. The finger is the right site, and motion is the main enemy.

Heart rate from wrist and finger wearables more broadly has been validated against gold-standard ECG. Bent et al. (2020), comparing six wrist-worn devices to a clinical-grade ECG across rest and activity in 53 participants, found that *"different wearables are all reasonably accurate at resting and prolonged elevated heart rate, but that differences exist between devices in responding to changes in activity"* [48, p. 1]. Resting heart rate from consumer wearables had a mean absolute error of *"7.2 ± 5.4 bpm"*, rising during activity to *"10.2 ± 7.5 bpm"* — an absolute error during activity approximately *"30% higher than during rest"* [48, p. 3]. The same paper examined whether skin tone independently degraded heart-rate accuracy and concluded *"we did not find statistically significant differences in HR or HRV accuracy across skin tones"* [48, p. 6], though it explicitly notes prior work has shown *"inaccurate PPG HR measurements occur up to 15% more frequently in dark skin as compared to light skin"* due to higher melanin absorption [48, p. 1]. The signal is real; quantifying it requires more diverse cohorts than most validation studies achieve.

The skin-tone issue is most consequential for SpO₂, not heart rate. Sjoding et al. (2020), the landmark NEJM analysis of 10,789 paired pulse oximetry / arterial blood gas measurements, found that *"Black patients had nearly three times the frequency of occult hypoxemia that was not detected by pulse oximetry as White patients"* [49]. Occult hypoxemia — true arterial saturation below 88% with pulse-oximeter reading between 92% and 96% — occurred in 11.7% of Black patients versus 3.6% of White patients in the Michigan cohort, and 17.0% versus 6.2% in the multicentre cohort [49]. The clinical implication, in the authors' own words: *"reliance on pulse oximetry to triage patients and adjust supplemental oxygen levels may place Black patients at increased risk for hypoxemia"* [49]. This applies to clinical-grade transmissive oximeters. A consumer reflective ring will at minimum inherit the bias and likely worsen it. The Neeve Ring therefore surfaces SpO₂ as a within-person trend with an explicit skin-tone caveat in the doctor PDF footer, never as an absolute number the user is asked to act on.

Heart rate variability (HRV) from PPG is well-validated for time-domain metrics in stationary conditions and progressively less defensible as you move to short windows and frequency-domain metrics. Cao et al. (2022), comparing the Oura Ring (finger reflective PPG, same broad architecture as the Neeve Ring) against a medical-grade chest ECG across overnight sleep in 35 healthy adults, reported that *"the Oura Ring could accurately measure nocturnal HR and RMSSD in both the 5-minute and average-per-night tests"* [50, p. 2], with HR Pearson correlation of 0.993 and mean bias of −0.44 bpm, and RMSSD correlation of 0.915 with mean bias of −14.97 ms over 5-minute windows [50, p. 6]. Averaged per night, agreement was high for HR (r = 0.99968) and RMSSD (r = 0.962), with narrower confidence intervals than the 5-minute analysis [50, p. 10]. But the same study found *"the LF and LF:HF ratio of the ring had high error rates in both tests"* [50, p. 2], with LF:HF Pearson correlation of only 0.355 over 5-minute windows. The clean reading: ring HRV is defensible as RMSSD trended within-person over nights or longer windows; absolute HRV is not defensible; frequency-domain HRV from a consumer ring is not defensible at all.

Respiratory rate from PPG is derivable but imperfect. Charlton et al. (2016), in the largest systematic comparison of respiratory-rate algorithms (314 algorithms tested against nasal-oral pressure reference), reported the best PPG-based algorithm achieved *"95% LOAs of −5.1 to 7.2 bpm and a bias of 1.0 bpm when using PPG"* [51, p. 610] — meaning a derived respiratory rate from a clean PPG signal is good to roughly ±6 breaths per minute on a single window. The same paper notes *"Algorithms performed better when using ECG than PPG"* [51, p. 610]. Translated: respiratory rate from the Neeve Ring is a useful trend variable, not a substitute for a count. Longmore et al. (2019) found that at the finger location specifically, respiration rate at rest had median error of *"0.55 rpm (±13)"* in red and *"0.11 rpm (±13)"* in infrared, but walking degraded this to *"6.5 rpm"* in red [47, p. 12]. The signal exists when the wearer is still and disappears when they move.

Cuffless blood pressure from PPG is the area where overclaiming is most common and the literature is most damning. Mukkamala et al. (2022), in the most authoritative recent review, conclude that despite years of effort *"no device or measurement principle has been widely accepted"* [52, p. 203] and that for the calibrated finger-PPG methods most consumer wearables would deploy, *"there is no compelling proof in the public domain indicating that they can accurately track intraindividual BP variations"* [52, p. 222]. The Neeve Ring's PPG-PWV-derived BP estimate exposed by the YC SDK falls squarely in this category. The Neeve Ring therefore never displays ring-derived BP to the user as a BP number, and the doctor PDF sources BP exclusively from manually entered cuff readings (see §7).

### 4.2 The Neeve Ring hardware

The Neeve Ring is, at the silicon level, an SoC built on the AC6323/RF03 chipset (Jieli AC69x family) running YC-Tech firmware. The reflective PPG front-end uses red, infrared, and green LEDs, and the device exposes its data via the YC SDK over Bluetooth. The metrics confirmed working on this hardware, verified through both the SDK `isSupport*` capability flags and observed firmware behaviour, are: heart rate, SpO₂, HRV (validated against paired user comparisons), respiration rate, step and activity, sleep stage (vendor-derived), and a PPG-PWV-derived blood pressure estimate that is calibration-dependent.

Metrics the SDK exposes but the hardware does not actually support: skin temperature returns statusCode = 0 but the firmware ignores the underlying request; blood fat and blood glucose are marketed by the OEM but non-functional on the AC6323 base. These are silently disregarded by the Neeve app and never surface in the doctor PDF.

Sample rates for PPG, ECG-equivalent, accelerometer, and temperature streams are technically configurable via `setDeviceSensorSamplingRate`, but this is an undocumented binary-SDK call we have never invoked. The Neeve Ring therefore runs at firmware defaults. Autonomous on-device monitor cadence is controlled separately via `setDeviceHealthMonitoringMode(interval:)`, documented default 60 minutes; Neeve currently operates at 10 minutes (down from an earlier 2 minutes that drained battery without improving signal). The clinical implication of the 10-minute cadence is that the Neeve Ring is not a continuous monitor in the holter sense. It is a discrete sampler. Engines that need finer resolution — the POTS active-stand replication in §5.1 in particular — must initiate an on-demand burst rather than rely on the background stream.

The form factor is reflective finger PPG. There is no ECG electrode. There is no functional skin-temperature sensor. There is no medical-grade pulse-transit-time pathway. The Neeve Ring is a consumer-grade reflective PPG ring with accelerometer, deployed on a Tier 1 chipset whose constraints we manage in software per the chipset-tier framework. That is the ceiling on what §4.3 is allowed to claim.

### 4.3 Per-metric defensibility table

The table below is the operative rule set. Every ring-derived value that appears anywhere in Neeve — in the Today view, in an engine input, in the doctor PDF — has to be consistent with one of these rows.
...
The engines in §5 each draw a specific subset of the table above. The constraints below define the input contract.

**POTS engine (§5.1).** Uses HR (well-grounded) and accelerometer-derived posture transitions (standard). The Δ-HR-on-standing threshold the engine looks for — ≥30 bpm sustained over 10 minutes after a sit-to-stand or supine-to-stand transition — sits well inside the ±5–10 bpm resting accuracy from [48, p. 3]. This is the engine with the cleanest defensibility profile. SpO₂ is not used as a POTS input.

**ME/CFS engine (§5.2).** Uses RMSSD nightly mean (trend only, within-person, per [50, p. 10]), step count and activity intensity (standard accelerometer), and resting HR trend. PEM detection rests on the combination of step-count drop, resting-HR elevation, and nightly-RMSSD shift relative to the user's own baseline, with each input flagged for confidence. The engine does not use frequency-domain HRV, does not use SpO₂ as a verdict, and does not use sleep stages as a primary signal.

**Migraine engine (§5.3).** Uses RMSSD nightly trend, respiration-rate nightly trend, and vendor sleep-stage proportions, all flagged as trend-only inputs. Prodrome detection looks for divergence from the user's own 14-day rolling baseline; the engine never asserts a stage from a single night. Sleep-stage data carries the lowest-defensibility flag of any input the engine uses.

**Endometriosis engine (§5.4) and fibromyalgia / anxiety-depression overlay (§5.5).** Ring inputs here are minimal and contextual: resting HR for autonomic baseline (well-grounded), nightly RMSSD trend (well-grounded within-person), step count for activity context. These engines lean predominantly on the EMA side; the ring is supportive context, not a primary signal.

A general rule applies across all engines: where multiple low-confidence inputs would have to be combined to support a claim, the engine reports the inputs separately rather than fusing them into an over-confident composite. The user sees observations like *"steps down, resting HR up, RMSSD lower than your usual nights"* as three separate facts, not a single "PEM detected" verdict.

### 4.5 Honest limits

Five limits worth naming so the doctor PDF doesn't have to discover them in failure mode.

**Off-finger artefacts.** Reflective PPG is only valid when the optical window is in good skin contact. The ring's "ring worn" state is inferred from accelerometer activity and PPG signal quality, not from a dedicated wear-detection sensor. Periods of poor contact produce noise that looks superficially like physiological signal. Engines therefore use signal-quality gating on every burst, and missing data is shown as missing — never extrapolated.

**Motion.** Per Longmore et al. (2019), walking widens finger SpO₂ error to >19% [47, p. 13]; per Bent et al. (2020), walking widens HR error by ~30% [48, p. 3]. Neeve never reports SpO₂ during user-flagged activity, and HR during activity is shown with a confidence label.

**Skin tone.** The pulse-oximetry skin-tone bias [49] is the single largest reason ring-derived SpO₂ is presented as a within-person trend with explicit clinical caveats, not as an absolute number. We will revisit this when the device cohort is large enough to characterise per-Fitzpatrick category, and we will be honest in the meantime.

**Sample-rate constraints.** Because we run at firmware defaults rather than calling `setDeviceSensorSamplingRate`, the effective PPG sampling rate for HRV is bounded by what the firmware chooses, not by what the SDK theoretically permits. This is a known constraint we accept as the price of stable behaviour on a Tier 1 chipset.

**Autonomous cadence (10 minutes).** The background monitor produces a discrete sample every 10 minutes, not a continuous stream. POTS detection therefore relies on an on-demand active-stand burst triggered from the app, not on the autonomous stream. The autonomous cadence is appropriate for nightly trends, daily-mean inputs, and slow-moving variables; it is not appropriate for transient events shorter than ~10 minutes.

**The BP calibration gap.** As above, the ring's PPG-PWV BP estimate is never shown to the user as BP. Until the consumer-PPG cuffless BP field produces *"compelling proof in the public domain"* [52, p. 222] of intraindividual tracking, BP in Neeve comes from manually entered cuff readings, calibrated and time-stamped per the cuff protocol.
...
Most chronic-illness patients don't have one condition. They have several, often overlapping, often diagnosed years apart with each new specialist starting from scratch. The Australian POTS registry found that registry participants were currently seeing a mean of 7.5 specialists each [16, p. 159]. Long COVID confers a 4.93× hazard ratio for developing ME/CFS [20, p. 1085]. Endometriosis sits in a cluster with migraine, IBS, fibromyalgia and autonomic dysfunction. Fibromyalgia overlaps measurably with POTS via shared autonomic dysfunction biomarkers. Migraine prodrome symptoms (fatigue, fog, neck stiffness) are indistinguishable in isolation from a baseline ME/CFS day. Anxiety and depression run as comorbidities across every condition above — and standard scales like PHQ-9 over-diagnose depression in this population because they score positive on somatic items (fatigue, sleep change, appetite) that are part of the underlying physical illness, not a separate mood disorder. The orthostatic-intolerance cluster is itself a triad: Yao and colleagues, reviewing 100 young POTS patients, note the association of POTS with joint hypermobility disorders and mast cell activation syndrome is *"now firmly established"* — hypermobility present in 13–34% and MCAS in 2–87% depending on the criteria applied — and warn that over-strict criteria *"misses opportunities for potential therapeutic strategies"* [61]. (This is the same hypermobility cluster the ADHD overlay sits inside, §5.7 [54].)

What this means for Neeve: the engines are modular but the user is one person carrying all of them. The Today screen surfaces patterns from whichever engines have signal. The doctor PDF renders multiple conditions side by side. The check-in core (pain, fatigue, fog, "anything off?") is condition-AGNOSTIC and asked of every user every day; condition-specific probes are an ADDITIONAL layer that engines attach. The dignity layer (§6) is condition-agnostic too — the way Alys speaks and the way the app shows confidence labels does not change between a POTS user and a fibromyalgia user. The structural commitment is: single-condition framing is wrong, and we never present the product or its output as if it were single-condition.

### 5.1 POTS — postural orthostatic tachycardia syndrome

POTS is the first per-condition pattern engine Neeve will ship. The reason is practical: POTS includes a measurable orthostatic heart-rate pattern, has a validated symptom-burden scale, and is strongly associated with diagnostic delay and dismissal. Neeve does not diagnose POTS. The engine identifies wearable-derived pattern candidates that may be consistent with published criteria, combines them with symptom and function data, attaches a confidence label, and surfaces them for the patient and, with consent, the treating clinician.

#### 5.1.1 What the diagnosis actually requires

The 2015 Heart Rhythm Society (HRS) Expert Consensus Statement is the canonical source for POTS criteria. POTS is described as a clinical syndrome with two pieces: a set of orthostatic symptoms (light-headedness, palpitations, tremor, weakness, blurred vision, exercise intolerance, fatigue) plus a sustained heart-rate rise when the person stands up, with blood pressure not dropping in the way it would for orthostatic hypotension [12].
...
**What the engine must not flag as POTS.** The HRS consensus is specific about disqualifiers:
...
- **Inappropriate sinus tachycardia (IST)** — a resting heart rate above 100 bpm with a 24-hour mean above 90 bpm, *"not due to primary causes"* [12, p. e45]. The engine distinguishes IST from POTS by asking whether the tachycardia is postural (POTS) or persistent at rest (IST).

#### 5.1.2 The active stand test — what we replicate in software

Neeve approximates the active stand test in software, using ring HR plus motion-derived posture and step changes. The reference protocol from the Malmö group, used to validate the MAPS score below, reads:
...
The case report from Breslin and colleagues describes the same pattern in practice: a Finometer recorded a heart-rate rise from about 90 bpm to over 120 bpm sustained for more than 3 minutes on standing, with the patient's symptoms reproduced. They describe the POTS signature as *"a sustained tachycardia >30bpm without significant blood pressure change within the first 10 minutes of moving from supine to upright"* [13, p. 2].

**How we do it without asking the user to lie down on cue.** The engine looks for naturally-occurring "stand events" rather than running a scheduled test:
...
The label in the app and the doctor PDF is **"POTS-pattern candidate"**, never "POTS detected" or "POTS likely". The literature is open about the active stand test's *"relatively low test-retest reliability"* [13, p. 2], so a single event is never enough. The engine requires multiple events across separate days before raising the pattern to the Today screen or the doctor PDF.

#### 5.1.3 The Malmö POTS Symptom Score — the validated scale we use

The Malmö POTS Symptom Score (MAPS) is, so far, the only validated self-report scale designed specifically for POTS symptom burden [14]. Neeve uses it for two things: a baseline at onboarding for users who tell us they have or suspect POTS, and a symptom-burden trend that goes into the doctor PDF.
...
**MAPS lines up with the heart-rate evidence.** At 3 minutes of standing, the MAPS total had a Pearson r of 0.658 (R² = 0.433, p<0.001) with orthostatic heart rate [14, p. 96, Fig. 4]. This is the empirical bridge that lets Neeve put ring-derived stand events and the MAPS trend on the same trajectory in the doctor PDF — they're measuring related sides of the same condition.
...
- **Almost two thirds (64.6%) had their symptoms blamed on anxiety before they were diagnosed** [16, p. 159]. This single number is the strongest reason Neeve exists as a clinical-grade pattern record rather than a wellness tracker — patients walk into appointments needing to be believed.
...
- **On average, patients had seen 5.2 doctors before diagnosis** (SD 4.6), and were currently seeing 7.5 specialists (SD 4.5) [16, pp. 159-160]. That's why the doctor PDF has to be portable and self-contained — the patient is the only constant.
...
The authors note that the Australian delay *"was longer than reported overseas, suggesting specific barriers in Australian health care"* [16, p. 160]. For a product whose explicit job is to give chronically-ill Australians proof their doctors can't dismiss, this is the headline. The engine, the check-in copy, and the doctor PDF are all calibrated against the registry's picture of the typical Australian POTS patient: a young woman whose symptoms have been put down to anxiety, who has seen five doctors and three emergency departments, and whose ring-derived pattern record is the most credible piece of longitudinal evidence she can take to her next appointment.
...
The International Consensus Criteria, written by 26 clinicians and researchers from 13 countries with around 400 years of combined clinical experience between them, made PEM the compulsory feature of the disease. They renamed it postexertional neuroimmune exhaustion (PENE) to push back against the idea that "malaise" — *"a vague feeling of discomfort or fatigue"* [17, p. 331] — is anywhere near adequate as a description. The criteria require all of the following:
...
**The Australian burden.** Eaton-Fitch and colleagues surveyed 480 Australians with ME/CFS using the SF-36 and found health-related quality of life *"significantly impaired … across all domains compared with the general population"*, with the lowest scores in physical role (4.11 ± 15.07) and energy/fatigue (13.54 ± 13.94) [62]. Impaired physical functioning was associated with *"females, higher body mass index (BMI), employment status, cognitive difficulties, sensory disturbances and cardiovascular symptoms"* [62] — the multimorbid, autonomic-overlapping picture Neeve is built for, in the Australian population it serves.
...
Migraine is the third per-condition pattern engine in Neeve. The reason is simple. Of all the conditions we engage with, migraine has the strongest research evidence for a real warning window before the pain hits — the prodrome. Hours, sometimes a day or more, before the headache starts, the body shifts. People feel tired. Lights get sharper. The neck stiffens. The mood drops. If a ring and a quiet app can pick up even part of that shift, the user gets time — time to slow down, dim the screen, take medication early if their doctor prescribed it, cancel a plan. That window is exactly where a wearable plus a short check-in could matter most. The engine's job is to identify a possible early-warning pattern. It never says "migraine predicted" or "migraine imminent" — that boundary is set in §10.

#### 5.3.1 What migraine actually is (diagnostically)

Migraine is not just a bad headache. The International Classification of Headache Disorders, 3rd edition (ICHD-3), defines it as a recurring condition with attacks that last hours to days, are usually one-sided, throbbing, made worse by ordinary movement, and come with nausea or strong sensitivity to light and sound. A subset of people also get aura — visual, sensory or speech symptoms that come before the pain. The 2018 ICHD-3 criteria are sharper than the older 2013 ICHD-3 beta version: in an emergency-room study of 128 patients, ICHD-3 had 96% specificity for migraine with aura and 98% for migraine with typical aura — significantly better than ICHD-3 beta, especially for distinguishing a first single attack from a transient ischaemic attack [22, p. 1]. The authors found *"the new ICHD-3 diagnostic criteria for migraine with aura and migraine with typical aura display an excellent specificity (96 and 98% respectively), and are significantly more specific than the previous ICHD-3 beta classification system when it comes to diagnosing a first single attack"* [22, p. 1]. Neeve uses ICHD-3 as its diagnostic frame and never attempts to discriminate aura symptoms from TIA in software — that decision belongs to a clinician.

#### 5.3.2 The prodrome window — what the literature says

The single best dataset on the prodrome is the PRODROME trial screening period. Over 60 days, 920 adults with migraine logged 4,802 "qualifying prodrome events" in an electronic diary — events where they were confident a headache would follow within 1 to 6 hours [23, p. 1]. The findings give Neeve its baseline:
...
PRODROME used a diary. So did the earlier 87-patient electronic momentary assessment (EMA) study by Houtveen and Sorbi, which is closer to what Neeve actually does — short prompts on a phone, several times a day, with each pre-attack moment compared to that person's own interictal baseline [24, p. 1]. They found that *"the prodromal change in migraine - relative to interictal functioning - predominantly exists within the last 12 hours before attack onset"* [24, p. 1]. The clusters that increased significantly in those last 12 hours were sensory sensitivity, pain/stiffness and fatigue, with a tendency for increased negative affect; positive affect and cognitive functioning were impaired earlier, with a dip 25–36 hours out and a bigger dip in the final 12 hours [24, p. 1]. The study also pushed back on a common belief: *"effort spent and stressors encountered both did not predict attack occurrence"* once interictal baseline was controlled for [24, p. 8]. The lesson Neeve takes from this: change is measured against the person's own baseline, not against a population average, and the most informative comparison is the day-before vs. recent typical day.

#### 5.3.4 Wearable detection of pre-migraine nights

The Kapustynska et al. 2024 study is the closest published model to what the Neeve Ring can do tonight. Ten people with episodic migraine wore an Empatica Embrace Plus on the wrist; the team trained machine-learning models on nocturnal signals to separate pre-migraine nights from migraine-free nights [25, p. 1]. The signals that mattered:
...
So a wrist wearable can pick up the pre-migraine night signal — but not reliably enough on its own to replace a person's report. One caveat binds the Neeve build: the signals that drove Kapustynska's model — electrodermal activity and skin temperature — came from an Empatica wrist band and are **not available on the current Neeve Ring** (reflective PPG + accelerometer; see §4.2). The migraine engine therefore leans on the inputs it does have — nightly HRV (RMSSD), respiration-rate trend, sleep architecture, resting-HR drift — plus the user's logged prodrome. The Neeve design is direct: ring signals raise or lower confidence in a pattern; the user's own logged prodrome is the anchor.

#### 5.3.5 MIDAS — the validated impact PRO

To track whether anything is helping, Neeve needs a validated disability measure, not a homemade rating. The Migraine Disability Assessment (MIDAS) is the most used instrument in migraine research, with five items covering missed and reduced work, household and social days over a recall period [26, p. 1]. Carvalho et al. ran the first proper responsiveness analysis on 103 patients with chronic or high-frequency episodic migraine. They found that *"a change of 4.5 points or more represents a clinically important change for patients with high frequent migraine and chronic migraine"* [26, p. 1], with a standard error of measurement of 1.5 points and a 95% minimum detectable change of 4.3 points [26, p. 3]. Responsiveness was *"limited"* (AUC 0.63–0.68) but the 4.5-point threshold was stable across three timepoints [26, p. 1]. Neeve uses MIDAS at intake and at quarterly review, treats a ≥4.5-point reduction as a meaningful change worth showing the user and their doctor, and never claims smaller score shifts are clinically real.
...
- The subjective severity of photophobia or phonophobia
...
Endometriosis sits in the same cluster as POTS and ME/CFS for many of the women Neeve is built for. The diagnostic delay is measured in years. Doctors call the pain "normal periods" and send them home. The condition overlaps with migraine, fibromyalgia, IBS, chronic pelvic pain, and autonomic dysfunction in ways that look like coincidence until you read the prevalence data. The engine's job is not to diagnose endometriosis — that's a clinician's call, and the gold standard still involves imaging or laparoscopy. The engine's job is to capture the cyclical pattern of pain and other symptoms varying with the menstrual cycle, hold that pattern alongside a validated impact measure, and hand the woman something her doctor cannot easily dismiss.

#### 5.4.1 What endometriosis is (and the diagnostic delay problem)

The 2022 ESHRE guideline — the most recent international consensus document — defines endometriosis as a chronic inflammatory disease in which tissue resembling the lining of the uterus grows outside it, mostly in the pelvis. The growth is driven by oestrogen, so it tracks the menstrual cycle. Pain and infertility are the two clinical hallmarks. Around 190 million women and adolescent girls worldwide are affected during reproductive age [27, p. 6].

The diagnostic delay is the part that matters most for product design. ESHRE puts it plainly:
...
Part of the delay is biological — superficial peritoneal endometriosis is hard to see on imaging, and ESHRE notes that *"a negative finding does not exclude endometriosis, particularly superficial peritoneal disease"* [27, p. 9]. Part is structural — laparoscopy is invasive and expensive. Part is cultural. Severe period pain still gets normalised by both patients and clinicians.

The clinical signs ESHRE asks doctors to take seriously are explicitly cyclical and non-cyclical, and the list is wider than most women are told:
...
In plain English, that's painful periods, deep pain during sex, painful urination, painful bowel movements, blood in stool or urine that comes with the cycle, shoulder-tip pain, lung symptoms that flare around bleeding, fatigue, and trouble conceiving. The word *cyclical* shows up repeatedly. That cyclicality is the signal Neeve is built to capture.

ESHRE also notes — and this is the line that licenses Neeve's approach — that symptom diaries may help even though they don't yet have trial-grade evidence of shortening time to diagnosis:
...
That sentence is the regulatory ceiling and the product brief in one paragraph. Objectify the pain. Empower the woman. Complement the doctor's history-taking. Do not claim to diagnose.

#### 5.4.2 EHP-30 — the validated disease-impact PRO

The Endometriosis Health Profile 30 (EHP-30) is the most thoroughly validated endometriosis-specific quality-of-life questionnaire in the literature. It was developed by Jones and colleagues in 2001 from women's own descriptions of what mattered to them, and has since been translated and re-validated across more than a dozen languages. Hansen and colleagues' 2021 confirmatory factor analysis in 304 Danish women with endometriosis settled a long-running debate about its internal structure, supporting the original five-factor model [28].

The five subscales are *pain*, *control and powerlessness*, *emotional wellbeing*, *social support*, and *self-image*. Each is scored 0-100, where lower is better quality of life. Items are rated *"Never (0); Rarely (1); Sometimes (2); Often (3); and Always (4)"* [28, p. 3]. Internal consistency is excellent: *"Cronbach's alpha for 'pain' = 0.96, 'control and powerlessness' = 0.94, 'emotional wellbeing' = 0.91, 'social support' = 0.88 and 'self-image' = 0.88"* [28, p. 5]. Test-retest reliability over a 6-12 week interval was high, and — critically for a cyclical disease — the score did not drift with where the woman was in her cycle:

> *"scoring might be largely unaffected by the cyclical/menstrual pain symptoms characteristic of endometriosis."* [28, p. 5]

That last property is what makes EHP-30 usable as a longitudinal impact measure inside Neeve. We can administer it at onboarding and at fixed intervals (a 4-weekly cadence aligns with ESHRE's general "follow-up should be individualised" framing [27, p. 9] and with how the Danish public health system already uses it: *"Once a year, patients are asked to fill out an electronic questionnaire, including relevant parts of EHP-30"* [28, p. 10]). The subscale trajectories tell us whether the woman's life is being eroded by the disease over time, independently of where she happens to be in her cycle on the day of completion. The Neeve doctor PDF can carry those trajectories as a clinical-grade impact signal.

#### 5.4.3 The Endometriosis Symptom Diary — daily PRO for cyclical tracking

Where EHP-30 measures the slow erosion, the Endometriosis Symptom Diary (ESD) measures the day. Gater and colleagues developed the ESD and its companion weekly Endometriosis Impact Scale (EIS) in 2020 to FDA Patient-Reported Outcome guidance standards, with concept-elicitation interviews in 45 women and cognitive debriefing in 31 more across the US, Germany and France [29].

The ESD is a 12-item electronic diary completed each evening with a 24-hour recall window. It covers worst pain in the "target area" (a body-map diagram, so women with pain in pelvis vs abdomen vs lower back can all anchor consistently), worst constant pain, worst short-term pain, whether the woman had her period in the past 24 hours, worst pain due to period, vaginal bleeding intensity (*"None / Spotting / Light / Normal / Heavy"*), whether she had intercourse, worst pain during or after intercourse, avoidance of intercourse, and three items on pain medication use [29, p. 8]. Pain is rated on a 0-10 numeric scale.

The concept-elicitation interviews behind the ESD are an unusually clear record of what endometriosis actually feels like in women's own words:
...
The symptom load extends well past pelvic pain. Gater documented *"tiredness (n = 40); headaches (n = 29); abdominal bloating (n = 26); nausea (n = 24); constipation (n = 14); vomiting (n = 12); dizziness (n = 12); diarrhoea (n = 9); lack of energy (n = 9)"* [29, p. 7], plus impaired sleep (n = 36), inability to concentrate (n = 28), and emotional impacts in all 45 participants. The ESD does not try to capture every one of these — it focuses on the pain, bleeding and analgesic-use core that an investigative or treatment study needs. The EIS, completed weekly with a 7-day recall, picks up the impact on physical activity, mood, social life, work, household activities, sleep, and concentration [29, p. 12]. Compliance in the pilot was good and daily completion averaged 2.5 minutes [29, p. 9] — a usability threshold Neeve has to match.

For Neeve, the ESD-equivalent items become the daily structured questions for women in the endometriosis engine. The 24-hour recall, the body-map diagram for pain location, and the use of a 0-10 NRS rather than a verbal scale are all defensible PRO design choices we can adopt directly.

#### 5.4.4 Australian context — diagnostic delay, prevalence, impact

Armour and colleagues' 2020 Australian online survey (n = 409, recruited through Endometriosis Australia, EndoActive and the Pelvic Pain Foundation of Australia) is the cleanest local data point on diagnostic delay and impact [30]. 340 respondents had surgically confirmed endometriosis; 69 had chronic pelvic pain without a confirmed endometriosis diagnosis.

The headline diagnostic-delay figure is grim, and the cohort effect is real:
...
Armour's survey was Sydney-led, drew respondents nationally, and provides the per-country numbers that the Neeve doctor PDF can lean on when contextualising a patient's symptom-burden trajectory. The diagnostic delay is reducing but not gone. The impact on work, study, and relationships is the daily texture of the disease and is exactly what longitudinal tracking can make visible.

#### 5.4.5 Comorbidities — why endometriosis sits in a cluster

Endometriosis travels with other diseases. Colombo and colleagues' 2025 systematic review and meta-analysis of 13 studies (32,489 women with endometriosis vs 299,166 controls) gives the strongest current pooled estimate for the migraine overlap [31]:
...
The association was stronger and more certain for migraine *without* aura (OR 2.64, 95% CI 1.89-3.69; I² = 0%) [31, p. 1] than for migraine with aura. The absolute risk increase Colombo reports is 46 more migraine cases per 1,000 women for all migraine, and 152 more per 1,000 for migraine without aura [31, p. 7]. The association strengthened with endometriosis severity — *"a diagnosis of migraine was more than four times more likely in individuals with moderate-severe endometriosis (rASRM stages III-IV) compared to those without (OR 4.52; 95% CI = 2.49-8.20)"* [31, p. 9].

Colombo's discussion of mechanism is the part that makes this section a comorbidity-cluster section rather than just a migraine section:
...
Chronic overlapping pain conditions. Central sensitisation. Shared inflammatory and genetic architecture. The Armour Australian survey adds that 38.8% of the endometriosis cohort reported chronic fatigue as a presenting symptom [30, p. 4]. Autonomic dysfunction also appears in the literature (the Endometriosis folder contains a paper on altered blood-pressure reflexes in women with endometriosis); we won't claim that overlap is settled, but its presence in the literature is one more reason the engine treats endometriosis as part of a wider picture rather than a siloed gynaecological problem.

The product implication: a woman with endometriosis in Neeve will often also be tracking migraine, fibromyalgia, IBS, fatigue, or POTS-spectrum symptoms. The engines have to be coherent across that overlap. The endometriosis engine surfaces cycle-locked patterns. The migraine engine surfaces prodrome and trigger patterns. The doctor PDF holds them together.
...
People with chronic illness get told their physical symptoms are anxiety. The Australian POTS registry put a number on it: 64.6% of patients had their symptoms attributed to anxiety before they were diagnosed [16, p. 159]. So when the engine adds a mood and anxiety overlay — and it has to, because depression and anxiety run alongside POTS, ME/CFS, endometriosis, migraine, and fibromyalgia at rates far above the general population — it has to do so without recreating the same mistake from the other direction. A chronically-ill person who is exhausted, sleeping badly, eating less, and unable to concentrate is not, on those grounds alone, depressed. They are chronically ill. The standard depression scales, particularly the PHQ-9, score positive on exactly those somatic items. Used as a verdict, they over-diagnose depression in this population. Neeve's job is to track mood and anxiety as a longitudinal comorbidity layer doctors can read alongside physical symptoms — never as a label, never as a notification, and never with the somatic items collapsed into the cognitive-affective ones.

#### 5.5.1 The validated scales we use — PHQ-9 and GAD-7

The PHQ-9 is a nine-item self-report depression scale built directly on the DSM-IV criteria for major depressive disorder. Each item is scored 0 ("not at all") to 3 ("nearly every day") over a two-week recall window, total 0–27. Kroenke and Spitzer describe it as *"a dual-purpose instrument that, with the same nine items, can establish provisional depressive disorder diagnoses as well as grade depressive symptom severity"* [32, p. 1]. The cut-points are *"5, 10, 15, and 20 … for mild, moderate, moderately severe, and severe depression, respectively"* [32, p. 2]. At the most-used screening threshold, *"a PHQ-9 score of 10 or greater… has a sensitivity for major depression of 88%, a specificity of 88%, and a positive likelihood ratio of 7.1"* [32, p. 2]. The ninth item — *"thoughts that you would be better off dead or of hurting yourself in some way"* [32, p. 2] — is the suicidality item and is treated separately by clinicians and (per §5.5.4) by Neeve.

The GAD-7 is the matched seven-item anxiety scale, same 0–3 response, same two-week window, total 0–21. Johnson and colleagues' psychometric study in a heterogeneous psychiatric sample of 1,201 patients found Cronbach's α of 0.88 at intake and convergent validity against the Beck Anxiety Inventory, SCL-90 anxiety, and the Global Severity Index [33, p. 1]. ROC analysis identified the best operating cut-off: *"a sensitivity of 0.92 and a specificity of 0.7 for a cutoff of 8"* [33, p. 6].

Critically — and this is the point that determines how Neeve administers both scales — Johnson and colleagues are explicit that a cut-off is *"a threshold for identifying possible cases in which further questioning to determine the presence and type of anxiety disorder may be warranted"*, and that *"the GAD-7 should not be used to screen for GAD when there are clinical samples characterised by high general distress"* [33, p. 6]. The scales are screeners. They are not diagnoses. They generate a flag for a clinician to look at, never a label for the app to display.

Two facts about validation bind the engine. Both scales were validated for a **two-week recall window** — *"Over the last 2 weeks, how often have you been bothered by any of the following problems?"* [32, p. 6]. They were not validated for momentary use, daily use, or repeated administration on shorter timescales. The Hall et al EMA review (§2) is explicit that copying a clinic questionnaire into a daily prompt breaks its validity. PHQ-9 and GAD-7 belong on a periodic cadence, not a daily one.

#### 5.5.2 The somatic-overlap problem

This is the part of the literature that matters most for Neeve. The PHQ-9's nine items include four that are intrinsically somatic — sleep change (item 3), fatigue (item 4), appetite change (item 5), and psychomotor change (item 8) — and one (item 7, concentration) that crosses into the cognitive territory ME/CFS calls brain fog. In someone who is chronically ill but not depressed, several of those items can score positive every day. A PHQ-9 total of 12 — moderate depression by the standard cut-points — can be reached with the four somatic items alone, before the person endorses a single cognitive or affective symptom.

Beswick and colleagues' multiple-sclerosis validation study is the cleanest illustration. Out of 103 community-dwelling pwMS, *"43% were categorised as depressed on at least one response"* [34, p. 1]. But the construct-validity findings were unexpected. PHQ-9 total scores were *"strongly positively correlated"* with the MS Impact Scale **physical** sub-score *"at the baseline time-point (r=0.86), and 4-week time-point (r=0.84)"* [34, p. 5] — a stronger correlation than the PHQ-9 had with the MSIS mental-health sub-score (r = 0.46 and r = 0.50). The authors conclude, honestly: *"Evidence of divergent validity was not observed in our study"* [34, p. 6]. Their interpretation is the clinical one — mental and physical health are tightly coupled in chronic illness — but the methodological point is unavoidable: a PHQ-9 in a chronically-ill person is partly measuring their physical disease.

Patient feedback in the same study made the case directly: *"Question 5 and 6 about depression doesn't allow for context which may affect the data you're collecting and your results. E.g. I am on medicine for depression but the depression is a result of fatigue"* [34, p. 6]. Patients can see the confound. They want the instrument to be able to.

Yokoya and colleagues' representative Japanese sample (n = 3,753) shows the problem from the population side. In multivariate analysis, **fatigue and malaise was the single strongest somatic correlate of a PHQ-9 score ≥ 10**: *"presence of fatigue and malaise (OR = 1.7, 95% CI 1.3–2.4) was significantly associated with PHQ ≥ 10"* [35, p. 1]. Age-stratified, the pattern shifts: gastrointestinal complaints in 18–39 year-olds, fatigue and malaise from 40 onwards, extremity pain added in over-65s [35, p. 1]. The authors' summary is the line Neeve designs around:
...
The instrument cannot, by itself, tell the depression story apart from the chronic-illness story. The literature offers three partial fixes. **Scoring the PHQ-9 without its somatic items** — Beswick cites Sjonnessen and colleagues, who *"found that scores were not altered by excluding items on fatigue and concentration"* [34, p. 2] in pwMS. **The PHQ-2**, an ultra-brief two-item screen with *"a sensitivity for major depression of 83%, a specificity of 90%"* [32, p. 5] at a cut-off of 3 — carries almost none of the somatic confound but loses the cognitive-affective texture doctors need. **PROMIS Depression**, which deliberately omits somatic items and is increasingly preferred in chronically-ill populations — Kroenke and colleagues validated the four-item PROMIS depression and anxiety scales in 244 primary-care patients with chronic pain and judged them *"reasonable options as ultra-brief measures for screening in patients with chronic pain"* [60, p. 1892], with an optimal screening cutpoint of 8 on the 4–20-point scale and a minimally important difference of ~2 points [60, p. 1892]. Neeve takes a fourth approach (§5.5.4): administer the full PHQ-9 and GAD-7 on the cadence they were validated for, and separate the somatic from the cognitive-affective items in the doctor PDF so the clinician can see which items are driving the total.

#### 5.5.3 Prevalence — why this matters for Neeve's audience

Khanal and colleagues' multi-disease study of 1,000 participants (800 chronic illness, 200 healthy controls) puts the comorbidity problem in numbers. Across all chronic-illness cases, *"We found higher frequency of depression (31% vs 11%; p=<0.001) and anxiety (13.25% vs 6%; p=0.021) among cases as compared to healthy controls"* [36, p. 1]. *"We found higher levels of depression among participants with non-communicable diseases as compared to communicable diseases (37.25% vs 24.75%; p<0.05)"* [36, p. 1]. Among non-communicable conditions, cancer ran highest at 67%, followed by diabetes 38%, cardiovascular 33% and respiratory 11% [36, p. 1]. The authors' framing of the mechanism matches Neeve's:
...
In Neeve's audience, depression and anxiety are not separate problems bolted onto the physical illness. They are part of how the illness expresses itself, often biologically. The screening apparatus has to see them clearly without confusing them with the physical illness driving them.

#### 5.5.4 What the Neeve engine does

- **Periodic administration on the cadence the scales were validated for.** PHQ-9 and GAD-7 are administered **in full, every two weeks**, never daily. The two-week recall window is the basis of their psychometric validation [32, p. 6]; using them on shorter timescales breaks the instrument. The cadence matches the MS validation study's repeated-administration design (ICC 0.89) [34, p. 1].
...
- **The engine does not ping the user when they score high.** A high PHQ-9 or GAD-7 in a chronically-ill person frequently reflects somatic load, not crisis. *"You scored 14 — you may be depressed"* would be clinically unsafe and a textbook receptivity violation (§3). High scores are surfaced in the doctor PDF for clinician review, not used to trigger in-app interventions.
...
Fibromyalgia is the "widespread pain + fatigue + cognitive" sibling condition in the chronic-illness cluster Neeve serves. It overlaps heavily with POTS, ME/CFS, migraine and endometriosis. Like POTS, it has been dismissed for decades and routinely routed to mental health before it gets named. The job of the Neeve fibromyalgia engine is the same shape as every other engine in §5: track widespread-pain pattern across body regions, fibrofog, sleep quality, and the autonomic overlap with POTS — and never claim to diagnose. Diagnosis is a clinician's call. The engine's job is to make the longitudinal picture credible enough that the clinician has something to work with.

#### 5.6.1 What fibromyalgia is — the ACR 2016 modified criteria

The canonical source for fibromyalgia criteria is the 2016 revision of the 2010/2011 American College of Rheumatology criteria, authored by Wolfe and colleagues — the same group who built the 1990, 2010 and 2011 versions [37]. The 2016 revision consolidates the physician-based 2010 criteria and the self-report 2011 criteria into a single dual-purpose criteria set, valid for both clinical diagnosis and research classification. For a software product whose primary surface is a self-report check-in plus passive ring data, the 2016 modified criteria are the right reference point.
...
Four things in that text shape the engine. The **WPI** is a count of pain sites across 19 body regions, scored over the previous week — the question is *"note the number of areas in which the patient has had pain over the last week. In how many areas has the patient had pain? Score will be between 0 and 19"* [37, p. 326]. The 19 sites group into five regions: left upper, right upper, left lower, right lower, and axial. The **SSS** scores three core symptoms — *"Fatigue, Waking unrefreshed, Cognitive symptoms"* — each on a 0–3 scale (*"0 = No problem … 3 = Severe: pervasive, continuous, life-disturbing problems"*) plus the presence over the prior six months of headache, lower-abdominal pain or cramps, and depression, each 0–1 [37, p. 326]. The **generalised pain criterion** — pain in at least 4 of 5 regions — was added in 2016 specifically to eliminate misclassification of regional pain syndromes (like chronic pelvic pain or chronic low back pain) as fibromyalgia [37, p. 325]. And the **3-month duration** floor and the explicit *"irrespective of other diagnoses"* clause together mean fibromyalgia can sit alongside POTS, ME/CFS or endometriosis without one ruling the others out [37, p. 326].

The same paper is clear about what the criteria do and don't do. The self-report version *"is not valid for clinical diagnosis in individual patients but is valid for research studies"* [37, p. 320]. That single sentence is the whole reason the Neeve engine never says "Fibromyalgia detected" — the literature is explicit that a self-administered version of these criteria, which is what a software product produces, is a screening and research instrument, not a diagnostic one.

#### 5.6.2 The validated impact PRO — FIQR

The Revised Fibromyalgia Impact Questionnaire (FIQR) is the validated patient-reported outcome for tracking how much fibromyalgia is actually doing to a person's life. It was developed by Bennett and colleagues in 2009 to fix known problems with the original FIQ — a complicated scoring algorithm, function questions written for a 1990s American household ("can you vacuum?", "can you use a washing machine?"), and the absence of items for memory, tenderness, balance and environmental sensitivity that fibromyalgia patients had since described as central to their experience [38, p. 2].
...
The psychometrics support using it. In 202 fibromyalgia patients, *"the mean FIQR total score was 56.6 ± 19.9"*, with the Cronbach alpha for the full instrument at *"0.95, with item-total correlations ranging from 0.56 to 0.93"* [38, p. 6]. The FIQR correlated 0.88 with the original FIQ and discriminated fibromyalgia from rheumatoid arthritis / lupus (mean 28.6 ± 21.2) and from major depression (mean 17.3 ± 11.8) with the fibromyalgia mean of 56.6 ± 19.9 sitting clearly above both control groups [38, p. 5]. The item that scored highest in fibromyalgia patients was *"sleep quality"* at 7.61 ± 2.4 — the highest of all 21 items [38, p. 6]. Patient completion time was *"1.3 minutes; scoring took about 1 minute"* [38, p. 1] — short enough that Neeve can administer it on a clinician-set cadence without burning the user's engagement budget.
...
The Fibromyalgia Survey Questionnaire (FSQ) is the fully self-administered version of the ACR 2010 criteria, validated by Häuser and colleagues in a cross-sectional study of 1,651 patients with physician-diagnosed fibromyalgia [39]. It packages the **WPI** and the **SSS** into a single short instrument, and the sum is called the **Fibromyalgianess Scale (FS)**, also known as the **polysymptomatic distress (PSD) scale** [39, p. 1], with a total range of 0–31.

In 1,651 patients, *"1411 (85.5%) participants of the total sample met the FSDC of FMS"*, and in a 128-patient subsample where the ACR 1990 tender-point criteria were re-evaluated, *"the concordance rate of the FSDC and ACR 1990 criteria was 72.7%"* [39, p. 4]. The authors are explicit about scope: *"The FSDC are not be used for self-diagnosis or as substitute for a physician's diagnosis. The FSQ can be used to gather information about the key symptoms of FMS and the extent of somatic symptom reporting, but the interpretation and assessment of questionnaire validity belongs to the physician"* [39, p. 5]. That sentence sets the wall the Neeve engine sits behind.

#### 5.6.4 Autonomic dysfunction + POTS overlap

Two papers in our reading make the autonomic-overlap case directly. Kang and colleagues compared 16 fibromyalgia patients with 16 controls and found that *"Patients with fibromyalgia had significantly higher SDNN/RMSSD values under both normal quiet breathing and rate controlled breathing compared to controls. Differences between the longest and shortest R-R interval under Valsalva maneuver were also significantly lower in patients with fibromyalgia than in controls"* [40, p. 301]. They name the physiology: *"patients with fibromyalgia present with blunted sympathetic vascular modulation and impaired cardiac vagal withdrawal to gravitational stress, and consequently reduced orthostatic tolerance"* [40, pp. 302, 305]. That last clause is the bridge to POTS.

Yagiz On and colleagues went further, testing 29 drug-free female fibromyalgia patients against 20 controls with Valsalva and tilt manoeuvres [41]: *"FM patients were found to have ANS dysfunction characterized by increased sympathetic response and decreased parasympathetic response"* [41, p. 327]. They add the link to severity: *"sympathetic activity, as measured with SSR amplitudes was found to be associated with the severity of FM"* [41, p. 332]. The same paper notes that *"a recent meta-analysis reported that the pooled prevalence of SFN [small fibre neuropathy] in FM was 49% with moderate heterogeneity"* [41, p. 333].

The plain reading: fibromyalgia is, in a large fraction of patients, an autonomically dysregulated condition with a measurable HRV signature, a measurable orthostatic-adaptation failure, and meaningful overlap with the small-fibre neuropathy that may underlie POTS in some of the same people. The fibromyalgia engine cross-references signals with the POTS engine, surfacing the autonomic-overlap pattern as a single picture rather than two unrelated alerts.

#### 5.6.5 What the Neeve fibromyalgia engine does

- **Ring measures passively that's useful:** resting heart rate, HRV (as a sympathovagal balance proxy aligned with the SDNN/RMSSD literature [40]), sleep architecture and sleep fragmentation (the FIQR's top-scoring symptom is sleep quality at 7.61 ± 2.4 [38, p. 6]), activity load against the user's rolling baseline, and orthostatic-pattern events shared with the §5.1 POTS engine.
...
- **Engine surfaces, with confidence labels:**
  ...
  - *"Sleep efficiency from the ring has been [up / down / steady] this week; felt sleep quality on your check-ins has been [up / down / steady]."* The two are always shown side by side — the divergence between measured sleep architecture and felt restorativeness is itself a fibromyalgia signal per the FIQR sleep item [38, p. 6].
...
Adult ADHD is an overlay, not a primary engine. It sits next to the anxiety and depression overlay in §5.5, for the same reason: it runs as a comorbidity through the chronic-illness population Neeve is built for, and it is heavily skewed toward women and toward adults late-diagnosed in their 30s and 40s — the same demographic that has been told for years that their POTS, ME/CFS, fibromyalgia or endometriosis was anxiety or stress. The patterns Neeve already captures map directly onto what ADHD assessment looks for: morning clarity and focus from the check-in, sleep onset latency and fragmentation from the ring, HRV and autonomic shape across the day. The engine surfaces those patterns with confidence labels. It never says a user has ADHD. Diagnosis sits with the psychiatrist, and in Australia that diagnostic pathway is its own structural problem — one the doctor PDF is built to help shorten, not to substitute.

#### 5.7.1 What adult ADHD actually looks like

Adult ADHD is a persistent neurodevelopmental condition with childhood onset, defined in DSM-5 by inattention, hyperactivity and impulsivity, with adult prevalence in the range of 2.8% across countries [53, p. 2]. Two findings matter for how Neeve thinks about it. First, the clinical picture in adults is broader than the DSM-5 core symptoms. Brevik and colleagues' Norwegian validation in 646 clinically-diagnosed adults and 908 controls found that *"the WURS had even better screening properties than the ASRS, in spite of our sample being clinically assessed and diagnosed in adulthood. The wider WURS dimensions of aggression, learning problems and emotional lability were highly relevant to identify adult ADHD in our sample, supporting a broader conceptualization of ADHD"* [53, p. 8]. Emotional regulation and executive function show up in the data as core, not comorbid. Second, adult presentations are dimensional: the same paper notes that *"the delineation of disorder versus normality is a universal problem when a diagnosis is based on symptoms that are dimensional and normally distributed, and it is of particular concern in a disorder for which controlled stimulant substances with potential for abuse are first-line treatments"* [53, p. 7]. That binds the engine — dimensional symptoms tracked over time can describe a pattern, but they cannot draw the line.

#### 5.7.2 The validated scales we use — ASRS-v1.1

The Adult ADHD Self-Report Scale (ASRS-v1.1) is the World Health Organization screening instrument. The full version is the 18 DSM symptom items rated on a 5-point Likert response (0 never → 4 very often), total range 0–72. The 6-item screener is the version most used in practice. Brevik and colleagues tested both in the Norwegian validation and found *"an AUC of 0.956 (95% CI: 0.946–0.965) for the WURS, and 0.904 (95% CI: 0.888–0.921) for the ASRS. The ASRS short screener had an AUC of 0.903 (95%CI: 0.886–0.920)"* [53, p. 1]. The 6-item screener performed as well as the full 18 items as a discriminator. At a cut-off of 35 on the full ASRS, the paper reports *"a sensitivity of 0.80 and specificity of 0.88 for the ASRS"* [53, p. 4]. The two-factor structure (inattentive + hyperactive/impulsive) was confirmed, explaining 62.2% of the variance [53, p. 6].

The paper is also explicit about what the ASRS does and does not do. The authors note that the ASRS is *"a brief screening instrument to identify current ADHD symptoms"* [53, p. 3] — a screener, not a diagnostic instrument. The Norwegian sample's adult-diagnosed patients had to meet ICD-10 / DSM criteria via clinical assessment by experienced psychiatrists and psychologists [53, p. 3]; the screener selected who got that assessment, it did not replace it. That distinction is the wall the Neeve engine sits behind.

A second methodological point in the same paper binds the cadence. The ASRS may be *"affected by short-term confounders such as affective fluctuations… time of day… and sleep problems"* [53, p. 8]. Daily administration would invite exactly those confounders. The Neeve engine administers the 6-item ASRS at onboarding for users who tell us ADHD is on their list of possibilities, then every 4–8 weeks. It is not a daily probe.

#### 5.7.3 The chronic-illness overlap

ADHD runs through the chronic-illness population at rates that are not accidental. Kustow's 2025 review of the somatic-comorbidity cluster puts the connection directly: *"Emerging research reveals a striking overlap between ADHD, hypermobility syndromes, immune dysfunction, and autonomic dysregulation. Studies suggest that approximately half of individuals with ADHD are hypermobile, while ADHD is significantly over-represented in those with hypermobility syndromes, such as Hypermobile Ehlers-Danlos Syndrome (hEDS) and Hypermobility Spectrum Disorder (HSD)"* [54, p. S54]. The same review names the syndrome cluster Neeve already serves: *"This 'somatic super-syndrome' encompasses many of ADHD's under-recognised somatic comorbidities, including hypermobility, allergy and autoimmunity, POTS, fatigue and pain syndromes (Chronic Fatigue Syndrome and Fibromyalgia Syndrome), and sensory processing issues"* [54, p. S54]. POTS, ME/CFS, fibromyalgia — the §5.1, §5.2, §5.6 engines — sit inside that cluster. ADHD is part of how the cluster expresses itself in a substantial subgroup of patients.

Sleep and circadian rhythm are the other side of the overlap. Luu and Fabiano's 2025 review reports that *"insomnia and sleep disturbances affect up to 80% of adults with ADHD and similarly up to 82% of children with ADHD, delayed sleep-wake timing occurs in up to 78%, and dim-light melatonin onset (DLMO) is delayed by approximately 45 minutes in children and 90 minutes in adults"* [55, p. 1]. The same paper describes *"phase delays of melatonin… in children and adults identified to have a delayed onset of about 45 minutes and 90 minutes, respectively"* [55, p. 2] and *"blunted and delayed cortisol rhythms"* with *"lower basal cortisol levels, particularly in the morning, compared to controls"* [55, p. 2]. These are precisely the signals the Neeve Ring captures passively — sleep onset latency, fragmentation, HR/HRV across the day. The ring cannot diagnose anything. But the phase-delay pattern shows up in the ring trace as later sleep onset, lower morning HRV, and a flatter cognitive-clarity curve in the morning check-in, and the engine surfaces that as a pattern worth taking to a clinician.

The late-diagnosis-in-women picture is the third overlap. Attoe and Climie's 2023 systematic review of adult ADHD in women across eight studies notes that *"in childhood, the ratio of boys to girls with ADHD is about 3:1 whereas in adulthood it is closer to 1:1, suggesting that women and girls are underdiagnosed in childhood"* [56, p. 645]. The mechanism is gender-pattern under-recognition: *"girls are more often diagnosed with ADHD-Inattentive (ADHD-I), exhibiting symptoms such as distraction, disorganization, and forgetfulness. Boys more frequently present with ADHD-Hyperactivity/Impulsivity (ADHD-HI)… These symptoms are often more disruptive in the classroom setting, leading to higher rates of referral for assessment in boys than girls"* [56, p. 646]. The clinical-pathway effect that follows is the one that lands these women in Neeve's audience: *"Many women seeking treatment for mood and emotional problems may have unrecognized ADHD… Higher rates of comorbidities such as depression and eating disorders in females with ADHD may make diagnosis more difficult. As well, physicians may have more difficulty separating ADHD from its comorbidities, potentially clouding ADHD symptoms and leading to delayed diagnosis in females"* [56, p. 646]. The same review documents the diagnostic experience: *"For many women, ADHD falls under the category of 'illnesses you have to fight to get'… Women often feel they need to prove symptoms for a physician to take them seriously and consider a diagnosis of ADHD"* [56, p. 647]. That is the same dismissal pattern §1 documents the medical system inflicting on chronic-illness patients in general.

#### 5.7.4 Australian diagnostic context

Diagnosis of adult ADHD in Australia sits almost entirely in the private sector. Bradlow, Armstrong and Ogden's 2025 MJA perspective puts the structural picture in print: *"Most adults with ADHD are diagnosed by private psychiatrists. The dearth of public services for ADHD raises serious concerns regarding equity of access and the potential that normal behavioural variability is 'medicalised'"* [57, p. 384]. The cost barrier is direct: *"The private model of ADHD diagnosis and treatment in Australia means that patients are often obliged to pay thousands of dollars and spend time on waiting lists before they can be assessed. This system selects out the people who have the financial capacity to afford the high medical costs and who possess the patience and organisational skills to navigate the complicated system, possibly excluding people who do not have the means to access private psychiatry"* [57, p. 384]. The same paper names the paradox the chronic-illness audience walks straight into: *"the impairments caused by untreated ADHD — particularly financial instability and poor executive functioning — make it more difficult for affected individuals to navigate the complex and costly process required to obtain a formal diagnosis"* [57, p. 384].

Mendonsa and Jayasooriya's 2025 audit of a private Australian clinic puts a number on the wait. In 68 patients referred between January 2023 and October 2024, *"wait times ranged from 10 days to 305 days, with a mean wait time of approximately 4 months (112 days). Almost 30% of the patients referred had wait time of more than 4 months"* [58, p. S792]. The sample was almost gender-balanced (33 male, 35 female), aged 17–56, and *"nearly all patients received their ADHD diagnosis in adulthood, with less than 5% having a childhood ADHD diagnosis"* [58, p. S792]. The pattern matches the literature on adult women: late diagnosis, in adulthood, after the chronic-illness picture has already taken shape. The structural lesson is the one §1 has already named — the patient is the only constant in their own care, and a portable longitudinal record is what shortens the road to the right clinician.

#### 5.7.5 What the Neeve ADHD-overlay engine does

- **Ring measures passively, on the cadence Neeve already runs.** Sleep onset latency, sleep fragmentation, HRV trends across the day, activity patterns (restlessness, irregular bursts), and a time-of-day cognitive proxy via HR variability shape. These map onto the phase-delayed picture Luu and Fabiano describe [55, p. 1]. No new sensor work is required; the ADHD overlay reads the same stream the POTS and ME/CFS engines read.
...
The dignity layer is the patient-facing equivalent of the doctor PDF in §7. The PDF is structured for a clinician's eye. The dignity layer is structured for a tired person's. Both serve the same goal — give the patient credibility they can carry into a room where they've been dismissed before. This section is the spec for the voice Alys uses, the way the Today screen presents observations, what confidence labels mean, how the app handles a bad day, and what we never do regardless of how engaging the alternative would be.
...
Neeve's doctor PDF is the clinical end-point that justifies the whole product. Patients walk into appointments needing to be believed — 64.6% of Australian POTS patients had their symptoms attributed to anxiety before diagnosis [16, p. 159], and the gender pain gap means women's pain is dismissed more often than men's [3, p. 2]. The PDF has to be portable and self-contained, because chronically-ill Australians change specialists often — the Australian POTS registry found participants were currently seeing a mean of 7.5 specialists each [16, p. 159]. It has to be structured the way doctors actually read evidence: within-person trends, validated patient-reported outcomes labelled as such, confidence labels not verdicts. And it has to respect both information-quality concerns that clinicians legitimately hold AND patient agency — the patient is the only constant in their own care, and the report is theirs.

This section is the spec the engineer designing that PDF reads.

### 7.1 The problem this PDF solves

A patient walks into an appointment with months — sometimes years — of lived experience. The doctor has fifteen minutes to absorb it. The PDF compresses without flattening.

Most patient-generated health data (PGHD) encounters in primary care fail at this step. Lordon and colleagues' systematic review across thirteen studies found that PGHD can improve communication and shared awareness, but the relationship benefit collapses when patients expect clinician engagement that clinicians don't have time to provide. They put it directly: *"Patient-generated health data and patient-reported outcomes may improve patient health awareness and communication with clinicians but may negatively affect patient–clinician relationships"* [43, p. 2]. The mechanism, in their data, was unmet expectations: *"Unmet patient expectations during clinical encounters, such as unsuccessful efforts to request medical information from clinicians, can negatively affect patient satisfaction, treatment adherence, symptom improvement, and relationships with clinicians"* [43, p. 9].

The fix the same review identified is also direct. Across the included studies, the format that worked for clinician workflow was the pre-prepared summary: *"summarized reports that could be interpreted quickly immediately prior to patient encounters, which worked well for existing clinician workflows"* [43, p. 10]. That is the format Neeve produces. A static document the patient brings to the appointment, scannable in under a minute, structured so the clinician can find what they need without the patient managing the clinician's time.

HealthTale's qualitative work makes the same point from the patient side. Smith and colleagues describe the gap as a mismatch between how patients construct their understanding and how clinical systems represent it: *"Patients often struggle to communicate coherent accounts of their health histories during time-constrained clinical encounters"*, and existing tools *"prioritize structured, clinician-centered data and provide limited support for eliciting and communicating patient-generated narratives"* [42, p. 1]. Their second design goal — the one Neeve's PDF inherits — is described as *"Communication: Support efficient communication through a static, shareable visualization artifact brought by the patient to an initial encounter with a clinician, enabling the rapid formation of a shared mental model"* [42, p. 2]. Static. Shareable. Brought by the patient. Those three properties are non-negotiable.

### 7.2 Information quality — what clinicians need to trust the report

Clinicians don't dismiss patient-generated data because they're cynical. They dismiss it because it usually arrives without the things they were trained to look for. West and colleagues' literature review of twenty-three empirical studies of clinician perceptions of self-tracked data identifies six dimensions of information quality that PGHD typically fails on: *"accuracy and reliability, completeness, context, patient motivation, and representation"* [44, p. 1]. They are explicit that the underlying problem is provenance: *"self-tracking tools produce data which are new and unfamiliar to clinicians, and are seldom clinically validated"* [44, p. 2].

The Neeve PDF answers each of those dimensions directly. The architecture is built around the answer.

**Accuracy and reliability.** Every metric in the PDF carries its instrument. Heart-rate data is sourced from the Neeve Ring, with sampling cadence noted in the methodology footer. Symptom-burden scores are named: MAPS, DSQ-PEM, MIDAS, EHP-30, FIQR, PHQ-9, GAD-7. Each score carries its published cut-off as a reference line on the trajectory chart. West and colleagues' diagnostic walk-through scenario lists the questions a clinician will ask first: *"Which instrument did Rupert use? How does Rupert's doctor know if this instrument is accurate?... Is it just a single reading? Is it an average of three readings? If it is an average, how much time passed between readings?"* [44, p. 10]. The footer answers all of them, in small type, by name and citation.

**Completeness and missingness.** Where data is missing, the PDF says so. Periods of non-wear, gaps in check-in completion, and check-ins skipped because of severe symptom load are surfaced explicitly as part of the record — not hidden. West and colleagues note that clinicians *"feared that poor compliance was potentially indicative of selective reporting, which was seen as a means of concealing information from the clinician"* [44, p. 8]. The mitigation is honest gaps. A missing day labelled "no check-in — symptom load high" is more credible than a smoothed line.

**Context.** Every ring-derived metric is set against the patient's own baseline, never against a population norm. West and colleagues describe this as one of the hardest things to get right: *"Single data streams on their own may provide insufficient context about a patient's recordings for clinicians to make suitable judgments from them"* [44, p. 9], and clinicians' implicit reference point — population data — *"may help in interpreting types of measurement uncommon in clinical settings"* [44, p. 9]. The Neeve PDF marks both: the patient's own 7-day and 30-day baselines as the primary reference, and where a published clinical cut-off exists (orthostatic ΔHR ≥30 bpm, MAPS ≥42, PHQ-9 ≥10), it is shown as a reference line — never as a verdict.

**Patient motivation.** West and colleagues are blunt about this dimension: *"a patient's motivation for self-tracking, the routine they followed to take measurements, and the device they used influence a doctors decision to use the data"* [44, p. 10]. The PDF's cover page names the user as the patient (not as a research subject and not as a wellness consumer), states the date range covered, and includes a one-line description of why they are tracking. Motivation is provenance.

**Representation.** West and colleagues' single most-quoted finding on format is that *"clinicians said temporal relationships were the most important, as they established causal relationships between potential triggers and symptoms. As a result, timelines were seen as the most natural way to represent patient self-tracked diaries"* [44, p. 4]. The Neeve PDF is a stack of small-multiple timelines, condition by condition, anchored to a common date axis. The cross-condition observations section depends on this shared axis to make co-occurrence visible.

The unifying principle: *"underlying data quality issues aside self-tracking systems today were viewed as more time-consuming and difficult to interpret, merely from a lack of presentational support for effective interrogation"* [44, p. 4]. Most PGHD doesn't get used because the format makes it expensive for the clinician to interrogate. The Neeve PDF is designed to be cheap to interrogate — under a minute to orient, two minutes to read deeply, one page per engine.

### 7.3 Visualization principles — what HealthTale teaches

HealthTale is the most directly relevant visualization study Neeve has, and most of its findings transfer. Smith and colleagues built a system that takes free-form patient narrative and produces a structured timeline, then evaluated it with 34 patients and 3 clinicians [42, p. 1].

The unit of representation is the within-person event group, not the population-relative score. Their data abstraction *"organizes them across two cross-cutting grouping structures: the type of health concern, and the timing of when they occurred"* [42, p. 1]. Neeve's PDF uses the same unit. The spine is the patient's story; the columns are the conditions; the rows are time.

Their clinician evaluation surfaced two findings Neeve directly inherits. The first is that the static visualization shifts effort: *"the visualization supports rapid orientation and shared understanding. Clinicians described using the timeline to get a high-level understanding at the beginning of an encounter, enabling them to quickly identify relevant Events and areas for further inquiry. This ability to establish a 'lay of the land' is particularly valuable in time-constrained settings"* [42, p. 8]. The Neeve PDF leads with the at-a-glance summary precisely so the clinician gets the lay of the land before reading anything dense.

The second is that completeness beats minimalism for static use. HealthTale clinicians said *"that even details they perceived as less relevant to the clinician might be important to be presented, and thus favored presenting a complete view rather than selectively pre-filtering the representation"* [42, p. 8]. The Neeve PDF therefore includes the patient's own-words section (§7.5) even though most of it will not be acted on — completeness is what makes the parts that do matter trustworthy.

HealthTale also documents what doesn't work. They went through several iterations to stop patients from misreading event-box width as severity, and to encourage richer temporal detail [42, p. 7]. The Neeve PDF inherits the corrections: event glyphs are uniform in size; severity is encoded only in the PRO score trajectory, never in glyph dimensions; dates are explicit.

A patient quote from HealthTale's evaluation captures why the static artifact matters more than a slick interactive dashboard: *"I think sometimes it can be hard when you're seeing a new doctor, because you're like, 'Here's where I currently am, but here's all the history and how we got here,' and that can get kind of brushed over sometimes. So to see it all visualized in the same place, I think would help get them up to speed a little bit faster without feeling like a big burden on myself as the patient"* [42, p. 8]. That is exactly the load Neeve's PDF lifts: the burden of being the only continuity in your own care.

### 7.4 The Project HealthDesign lessons

Project HealthDesign was a Robert Wood Johnson Foundation programme that funded five academic teams to integrate PGHD into clinical workflows across asthma, cognitive decline, adolescent behavioural health, Crohn's disease, and premature infant follow-up. Cohen and colleagues' evaluation interviewed 13 study-team members and 12 clinicians [45, p. 1]. The findings establish what real clinical integration costs.
...
**EHR integration is hard and not a precondition for value.** The PHD teams encountered repeated barriers around data storage, HIPAA-compliance, dashboard customisation, and clinician workflow integration [45, pp. 5–6]. Neeve sidesteps this entirely by being a paper document the patient brings to the appointment. No EHR write. No portal login. No third-party data storage from the clinician's perspective. The patient holds and shares the artefact. Cohen and colleagues note that *"keeping ownership of these data with patients might avoid some of the legal complications of having the outpatient organization maintain PGHD"* [45, p. 7] — that is the architecture Neeve uses by default.

**Most clinicians don't have time. Most patients don't have the digital literacy to build their own summary.** The same paper notes that PHD studies struggled because *"the usefulness of PGHD in the outpatient setting rests not only on data having clinical relevance but also relies on patients to collect these data"* [45, p. 7]. The Neeve PDF is generated by the app from the existing check-in and ring data — the patient does not assemble it manually. The patient's only act is to print it (or open it on their phone in the room) and bring it.

What the PHD evaluation also surfaced — and what every other PGHD-in-clinic study has surfaced since — is that clinician trust is built by familiarity with the format more than by the underlying data. Lordon and colleagues' review found that PGHD integration worked best when *"clinicians reviewed brief summaries of PGHD prior to meeting with patients, which facilitated PGHD clinical integration"* [43, p. 10]. The Neeve PDF is designed to be that summary — the same shape every time, the same sections in the same order, so a clinician seeing their second or third Neeve patient orients instantly.

### 7.5 The Neeve doctor PDF — structure spec

Rajabiyazdi and colleagues frame patient-generated-data visualisation as a wicked problem. They argue that *"designing patient-collected health data visualizations to support discussing patient data during clinical visits is a challenging problem due to the heterogeneity of the parties involved: patients, healthcare providers, and healthcare systems"* [46, p. 1], and that *"wicked problem solutions cannot be black or white"* [46, p. 2]. Their conclusion after five years of iterative design work with patients and clinicians in Alberta is that the only defensible approach is to *"design individualized solutions by considering each patient. Each patient has a unique body, a highly individualized lifestyle, a different set of goals, and a personalized patient-provider relationship"* [46, p. 7].

Neeve's resolution of this is structural: the PDF has a fixed skeleton so clinicians can orient instantly, and individualised content within each section so the artefact reflects the actual patient. Below is the binding spec.
...
This section is the binding regulatory and safety spec for everything Neeve says and does. It is the reference any team member can point at when a draft of website copy, an app string, a marketing email, an investor deck, or a TestFlight build needs to be vetted. It also captures what Neeve will never claim, regardless of how engaging the alternative would be, because the audience the product serves has been failed by enough overpromising health software already.

### 8.1 The line — wellness vs medical device

In Australia, software products are regulated by the Therapeutic Goods Administration under the Therapeutic Goods Act 1989 and the Therapeutic Goods (Medical Devices) Regulations 2002. The relevant distinction for Neeve is between **wellness software** (generally outside the scope of TGA regulation under the Excluded Goods Order) and **Software as a Medical Device (SaMD)** (regulated, classified, and assessed). The trigger for SaMD classification is intent — does the software diagnose, prevent, monitor, treat, or alleviate disease in a person? If yes, it is regulated. If no, it is wellness.

Neeve's structural commitment is to stay on the wellness side of that line. The commitment shows up in three concrete ways:

1. **No diagnostic claims.** The Claim Library (§9) and the Regulatory Boundary table (§10) are the operational mechanisms. Every output of every engine, every line of marketing copy, every PDF heading, every Today-screen observation has to pass the Claim Library. The forbidden phrases — *"X detected"*, *"X likely"*, *"X confirmed"*, *"X predicted"* — are the ones that flip the product into SaMD territory.
2. **No therapeutic claims.** Neeve does not claim to treat any condition. The dignity layer voice in §6 frames lifestyle suggestions as user-run experiments backed by general research, not as personal prescriptions. *"Want to try halving your caffeine for a week and let your check-ins tell you what happens?"* is wellness. *"Cut caffeine to treat your anxiety"* is a therapeutic claim and is therefore not permitted.
3. **No prediction of medical events.** Neeve does not predict migraines, crashes, flares, or any acute medical event. The migraine engine (§5.3) and the ME/CFS engine (§5.2) both use the language *"possible early-warning pattern"* and *"possible post-exertional symptom increase"* — observation, not prediction. The Regulatory Boundary table is explicit.

The same logic applies to the FDA framework (relevant when Neeve eventually targets the US market). Patient-Reported Outcome (PRO) instruments are validated for clinical use under FDA guidance documented in the IMMPACT recommendations (referenced via the May et al EMA review of chronic pain methodology [59]). Neeve administers validated PROs (MAPS, DSQ-PEM, MIDAS, EHP-30, FIQR, PHQ-9, GAD-7) at their validated cadence and uses their published cut-offs as reference lines, not as verdicts. The instruments do the clinical work; Neeve provides the longitudinal-administration shell.

### 8.2 What Neeve explicitly does NOT claim

The Regulatory Boundary table in §10 is the authoritative list. Pulling the categorical commitments together:

- Neeve does not diagnose any condition. POTS, ME/CFS, migraine, endometriosis, fibromyalgia, anxiety, depression — none of them. Diagnosis requires clinical assessment with ruled-out differentials, which Neeve is structurally incapable of providing. The engines surface *pattern candidates* with confidence labels; the doctor closes the loop.
- Neeve does not predict acute medical events. No "migraine in 4 hours" alerts. No "you will crash tomorrow" notifications. The migraine engine names *possible early-warning patterns*; the ME/CFS engine names *mild post-exertional symptom increase*. Both are observations of current state, not predictions of future state.
- Neeve does not replace medical care. The user is encouraged to take the doctor PDF to their clinician. The app is for what happens between appointments, not as a substitute for them.
- Neeve does not prescribe medication. Full stop, regardless of how strongly the data suggests one would help. That is illegal without medical credentials.
...
- Neeve does not produce wellness scores. No "you're at 73% today", no daily rating, no aggregate "health score". The dignity layer in §6 documents why structurally — wellness scores punish chronic illness and recreate the exact dismissal §1 documents.
...
The voice rule in §6.2 is the structural mechanism that lets Neeve be useful without crossing the line. Every direct suggestion follows four pillars:

1. **Cited general evidence.** *"Caffeine is a stimulant linked to higher anxiety and lower HRV in most people"* — population-level, citable, not personal.
2. **Within-person observation.** *"Your HRV has been lower than your usual range for two weeks"* — the user's own baseline.
3. **Invitation to experiment.** *"Want to try halving it for a week?"* — the user is the scientist; consent is structural.
4. **Data as the verdict.** *"Your check-ins and HRV will tell you what changed."* — the app does not pronounce the result; the user's own longitudinal data does.

This pattern is the same one Oura, WHOOP, Garmin, and every other credentialed wellness app uses to stay on the wellness side of the regulatory line. It works because it preserves user agency, sidesteps prescriptive claims, and makes the data the protagonist rather than the algorithm.

### 8.4 The Claim Library as a governance mechanism

§9 Claim Library is not just a marketing convenience — it is a regulatory governance commitment. Every claim Neeve makes about itself, its outputs, or its evidence has a row. The columns are: the claim, whether it's allowed (yes / yes-with-conditions / no), the evidence with citation, and the safer wording we use when the strong claim isn't allowed.
...
When a draft of any of the above uses wording that doesn't match the "Safer wording" column of the Library, the draft loses. The Library is updated before the draft, not after. This discipline is what keeps a small team consistent over years as the product surface expands.

### 8.5 Apple App Store considerations

The Apple App Store Review Guidelines impose additional constraints on health-and-fitness apps. The relevant sections are 1.4 (Safety — Physical Harm) and 5.1 (Privacy). Neeve's structural posture:
...
- **In-app data deletion.** Per Apple §5.1.1 (v), apps that collect health data must provide in-app deletion of that data. Neeve provides a "delete my data" flow in Settings that wipes the user's records from the backend and confirms the deletion. The user owns their data and can take it back.
...
Under the Privacy Act 1988, health information is sensitive information and attracts the highest level of protection. Neeve's commitments under the Australian Privacy Principles (APPs):
...
- **APP 3 (collection only of what's necessary).** Neeve collects what the engines need. Nothing else. The questions in the daily check-in are scoped to felt-experience + named context; the ring streams what the user has consented to.
...
Data ownership is structural: the user owns their data. Neeve is a custodian, not a proprietor. The doctor PDF stays patient-owned and paper-portable (§7) precisely because that's the architecture that respects ownership at every step.

### 8.7 Safety-net behaviours that do NOT require regulation

Some safety-net behaviours are added not because regulation requires them but because the chronic-illness audience deserves them:

- **Suicidality footer on PHQ-9 item 9.** PHQ-9 item 9 screens for suicidal ideation. When a user scores 1 or higher on item 9, the in-app footer surfaces Lifeline (13 11 14), Beyond Blue (1300 22 4636), and the option to text 0477 13 11 14. The footer is quiet, always available, and never blocks the rest of the app. It is not contingent on a "concerning score" threshold — the footer appears any time item 9 is non-zero.
- **Crisis language sensitivity.** If the user writes free-text containing crisis-indicative language (named patterns from clinical literature on suicide-screening NLP), Alys stays silent on observations that day and the footer surfaces with extra prominence. This is not an emergency response system — that is explicitly disclaimed — it is a dignity-preserving behaviour for a moment that warrants it.
...
Neeve's wellness-side positioning is contingent on the structural commitments above. The posture changes if any of the following ever ships:
...
Any of those is a one-way door to SaMD classification. Crossing it requires regulatory submission, clinical validation studies, post-market surveillance, and ongoing reporting. None of that is impossible — many credentialed digital therapeutics live there — but it is a categorically different product. Neeve's current positioning is wellness, and the foundations doc, the Claim Library, the Regulatory Boundary table, and the dignity layer are the structural mechanisms that keep it there.
